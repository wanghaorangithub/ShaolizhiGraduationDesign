...
/**
 * 这是一个Fragment，被FragmentB加载，它的作用是加载一个RecyclerView
 * Created by shaol on 2017/4/18.
 */
...
public class RecyclerViewFragment extends Fragment {
    ...
    /**
     * 用「数据提供者类」给「数据提供者接口」（就是上面的三个变量）赋值，
     * 由于现在没有写数据提供者类，所以先在这里先用「模拟值」当做「数据提供者类」给「数据提供者接口」赋值
     */
    private void modelToView() {
        ...
        map_slider_list.put("1", R.drawable.main_1);
        map_slider_list.put("2", R.drawable.main_2);
        map_slider_list.put("3", R.drawable.main_3);
        map_slider_list.put("4", R.drawable.main_4);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.recycler_view_fragment, container, false);
